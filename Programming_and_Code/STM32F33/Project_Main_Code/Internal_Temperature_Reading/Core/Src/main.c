...
uint32_t ADC_Value = 0;		//initial value
float voltage_of_sensor = 0; //initial value
float voltage_at_25 = 1.43; //provided in the datasheet
float avg_slope = 4.30; //provided in the datasheet
float temperature;
